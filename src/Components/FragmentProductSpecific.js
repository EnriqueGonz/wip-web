...
const giftUrl = 'http://127.0.0.1:8000/products/api/specific_product/'+id_product+'/';
const url = 'http://127.0.0.1:8000/products/gift/NQ/axc4ew-b862f7e5d78cfca061a25dfd0e59a4e4/';
// NQ/axc4ew-b862f7e5d78cfca061a25dfd0e59a4e4
...
const FragmentProductSpecific = () =>{
  ...
  const postPedido = () => {
    ...
    const urlPedido = 'http://127.0.0.1:8000/orders/api/order/';
